...
*  Modified to include custom capabilites & commands in MarianoColmenarejo's Zigbee Bulb Multifunction Mc by Bob Throckmorton
*
...
public static String driverVer() { return "1.3.1" }
